...
export enum DACommandType {
  ...
  APPLY_FLEXIBLE_WIRE_EDGES = 'APPLY_FLEXIBLE_WIRE_EDGES',
  APPLY_WEIGHTED_CHAIN_EDGES = 'APPLY_WEIGHTED_CHAIN_EDGES',
}
...
export type DACommand =
  ...
  | {kind: DACommandType.APPLY_FLEXIBLE_WIRE_EDGES}
  | {kind: DACommandType.APPLY_WEIGHTED_CHAIN_EDGES}
