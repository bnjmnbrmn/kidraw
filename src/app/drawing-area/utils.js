...
exports.lineIntersectsGroupBoundingRect = lineIntersectsGroupBoundingRect;
class LineSegment {
    constructor(p1, p2) {
        this.p1 = p1;
        this.p2 = p2;
    }
    getLineIntersection(other) {
        const x1 = this.p1.x;
        const x2 = this.p2.x;
        const y1 = this.p1.y;
        const y2 = this.p2.y;
 ...
 */
function lineIntersectsGroupBoundingRect(line, group) {
