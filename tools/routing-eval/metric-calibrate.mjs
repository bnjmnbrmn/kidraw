...
const FEATURE_KEYS = ['totalLength', 'totalCurvature', 'maxBulgeRatio', 'minObstacleClearance', 'minEdgeEdgeClearance', 'nonSiblingCrossings', 'minCrossingAngleDeg'];
...
const HAND_TUNED_WEIGHTS = { totalLength: -0.01, totalCurvature: -2, maxBulgeRatio: -50, minObstacleClearance: 0.5, minEdgeEdgeClearance: 0.5, nonSiblingCrossings: -5, minCrossingAngleDeg: 1 };
